...
cleanUp(dirtyArray: dirtyWordsArray)
//print(cleanUp(dirtyArray: dirtyWordsArray))
//: __Problem 5__
//:
...
myArchive.filterByDirector(currentDirector: "Richard Linklater", movies: movies)
